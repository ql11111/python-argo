...
UUID = os.environ.get('UUID', '4039ad7f-d501-447c-97ba-c3503867e27f')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
PORT = int(os.environ.get('SERVER_PORT') or os.environ.get('PORT') or 2828) # 订阅端口，如无法订阅，请手动修改为分配的端口
